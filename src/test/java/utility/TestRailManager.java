...
public class TestRailManager {
    ...
    public static String testRailUserName = "TestRailLoginMail";
    public static String testRailPassword = "TestRailPassword";
    ...
    public static void addResultsForTestCase(String testCaseId, String error, int status){
        ...
        try {
            ...
            if(status == testCaseFailStatus){
                ...
                System.out.println("Ekran görüntüsü ilgili test case'e eklendi!");
            }
